...
![npm](https://img.shields.io/npm/v/ai-env-sync)
![Node.js](https://img.shields.io/badge/node-%3E%3D16.0.0-brightgreen)
![License](https://img.shields.io/npm/l/ai-env-sync)
![TypeScript](https://img.shields.io/badge/typescript-%3E%3D4.0-blue)

# Environment variables synchronization and management tool

Environment variable synchronization. Syncs .env files across environments with validation.
...
[![GitHub stars](https://img.shields.io/github/stars/lxgicstudios/ai-env-sync)](https://github.com/lxgicstudios/ai-env-sync/stargazers)
